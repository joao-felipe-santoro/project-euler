...
describe('Problem 004', function () {
  ...
  it('[SOLUTION]Should return 906609 as the highest highest palindrome product of 3-digits number.', function () {
    const solution = problem004(3)
    expect(solution).to.equal(906609)
